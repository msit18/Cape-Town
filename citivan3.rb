...
#puts "Current call is active #{$currentCall.isActive}------------------------------------------------"
#call "+13392044253", { :network => "SMS"}
#puts "new message------------------------------------------------------------------------------------"
#puts "CITIVAN #{Citivan.new($currentCall.callerID.to_s)}---------------------------------------------"
#og "Current call is active2 #{$currentCall.isActive}-----------------------------------------------"
#puts "after citivan----------------------------------------------------------------------------------"
#puts "Current call is active3 #{$currentCall.isActive}-----------------------------------------------"
...
if $currentCall.isActive
    ...
    say "Current active phone is1 #{$currentCall.callerID}"
else
    call "+13392044253", { :network => "SMS"}
    say "started new call1"
end
